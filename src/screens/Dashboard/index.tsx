...
export function Dashboard() {
    ...
    const [highlightCardData, setHighlightCardData] = useState<HighlightCardProps>({} as HighlightCardProps);

    function getLastTransactionDate(transactions: TransactionCardListProps[], type: 'income' | 'expanse') {
    ...
    async function loadTransactions() {
        ...
        const formatedTransactions: TransactionCardListProps[] = transactions
        .map((transaction: TransactionCardListProps) => {
        ...
        const lastTransactionIncome = incomeSum && getLastTransactionDate(transactions, 'income');
        const lastTransactionExpanse = expanseSum && getLastTransactionDate(transactions, 'expanse');
